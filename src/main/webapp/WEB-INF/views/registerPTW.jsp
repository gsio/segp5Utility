...
#registerEquipTable .timepicker-box {
    display: flex;
    flex-direction: row;
...
#registerEquipTable td input.timepicker {
    text-align: center;
    font-weight: 600;
}
		...
		<div class="web-reg-box table-container">
			<table id="registerEquipTable" 
				...
				<tr>
					...
					<td colspan="2" class="text-left">
						<div class="file-item" style="height: 100%;">	                        
	                        <form:input type="file" id="filename1" class="upfile-image form-control" path='equip_img_file'/>
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2" class="text-left">
						<div class="timepicker-box">
							...
							<form:input id="equip_check_start" class="timepicker form-control" path="check_start" />
							<span>&nbsp~&nbsp</span>
							<form:input id="equip_check_end" class="timepicker form-control" path="check_end" />
				...
				<tr>
					...
					<td colspan="2" class="text-left">
						<div class="timepicker-box">
							<form:input id="equip_insur_start" class="timepicker form-control" path="insur_start" />
							<span>&nbsp~&nbsp</span>
							<form:input id="equip_insur_end" class="timepicker form-control" path="insur_end" />
						</div>	
					</td>
				</tr>				
